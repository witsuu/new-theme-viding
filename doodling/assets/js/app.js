...
const getPercentage = (x, max) => {
	return x / max * 100
}

const ts = document.querySelectorAll(".title-section")

ts.forEach(el => {
	const w = el.clientWidth
	const mxw = document.body.offsetWidth

	if (getPercentage(w, mxw) > 50) el.querySelector(".line").style.width = "80%"
})
